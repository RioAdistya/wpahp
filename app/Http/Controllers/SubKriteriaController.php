...
class SubKriteriaController extends Controller
{
	...
	{
		return DataTables::of(SubKriteria::with('kriteria')->select('subkriteria.*'))
	...
	public function store(Request $request)
	{
		...
		try {
			if ($request->id) {
				SubKriteria::updateOrCreate(['id' => $request->id], [
	...
	{
		$subkriterium->delete();
		if (!SubKriteriaComp::exists()) SubKriteriaComp::truncate();
