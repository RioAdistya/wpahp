...
@section('page-desc')
    ...
    @else
        Silahkan login untuk menggunakan Aplikasi Sistem Pendukung Keputusan
    @endauth
@endsection
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <p>Sistem ini akan membantu seseorang membuat keputusan dengan menggunakan metode Simple
                Analytical Hierarchy Process (AHP) dan Weighted Product (WP).</p>
            <p>Pembobotan Kriteria dan Sub Kriteria menggunakan metode AHP, sedangkan pembobotan
                Alternatif menggunakan metode Weighted (WP).</p>
                ...
                <div class="col-6 col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                                    <div class="stats-icon blue mb-2"><i class="fas fa-list-ul"></i></div>
                                </div>
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
