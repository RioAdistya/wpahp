...
@section('content')
<div class="modal fade text-left" id="AlterModal" tabindex="-1" role="dialog" aria-labelledby="AlterLabel" aria-hidden="true">
...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="card">
			<div class="card-body">
				<div class="d-flex align-items-start justify-content-between" data-bs-toggle="tooltip" title="Klik kolom Nama Alternatif untuk mencari Alternatif duplikat">
					<div class="content-left">
						<span>Duplikat</span>
						<div class="d-flex align-items-end mt-2">
...
<div class="card">
	...
	<div class="card-body">
		...
		<table class="table table-hover table-striped" id="table-alter" style="width: 100%">
			<thead>
				<tr>
					<th>Kode</th><th>Nama Alternatif</th><th>Keterangan</th><th>Aksi</th>
				</tr>
			</thead>
		</table>
	</div>
	...
	$(document).ready(function () {
		try {
			...
			dt_alternatif = dt_alternatif.DataTable({
				...
				serverSide: true,
				processing: true,
				ajax: {	url: "{{ route('alternatif.data') }}"	},
				columns: [
					{ data: "id" },	{ data: "name" },	{ data: "desc" },	{ data: "id" }
				],
				columnDefs: [{targets: 0,	render: function (data) { return 'A' + data; }}, 
				{
					targets: 2,
		...
		}).always(function () {	formloading('#AlterForm :input',false);	});
	});
