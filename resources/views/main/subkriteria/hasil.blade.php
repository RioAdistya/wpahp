...
<div class="card">
	<div class="card-header"><h4 class="card-title">Normalisasi dan Eigen</h4></div>
	<div class="card-body">
		<div class="table-responsive">
			<table class="table table-hover table-striped text-center">
				<thead>
	...
	<div class="card-body">
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tr>
					<td>Consistency Index (CI)</td><td>{{ round($data['ci'], 5) }}</td>
				</tr>
				<tr>
					...
					<td>
						...
						@else @php $consistent = true; @endphp -
						@endif
					</td>
				</tr>
				<tr>
